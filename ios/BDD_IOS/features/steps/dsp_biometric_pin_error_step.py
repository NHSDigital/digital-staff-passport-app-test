"""Step definitions for sign in after initial setup page steps"""
...
def dsp_pin_error_validation(context, message):
    ...
    messages_provide = {
        ...
        "Cannot use reverse sequential as well": (context.pin_error.app_pin_reverse_sequential_validation,
                                                  error_pin_not_six_digit),
        "PIN not repeated": (context.pin_error.app_pin_not_repeated_validation, error_pin_do_not_match),
        "PIN not repeated vice versa": (context.pin_error.app_pin_not_repeated_viceversa_validation,
                                        error_pin_not_six_digit),
