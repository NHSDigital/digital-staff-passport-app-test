...
def hr_portal_click_on_create_temporary_placement_credential_link(context):
    """step implementation Click on the Create temporary placement credential link"""
...
def hr_portal_validate_heading_and_proceed_further(context):
    """step implementation Validate the next page header and proceed further"""
...
def hr_portal_add_details_in_position_title_field(context):
    """step implementation Add the details in position title field"""
...
def hr_portal_add_details_in_position_number_field(context):
    """step implementation Add the details in position number field"""
...
def hr_portal_add_details_in_brief_description_of_work_pattern(context):
    """step implementation Add the Brief description of work pattern"""
...
def hr_portal_add_temporary_credentials_start_date(context):
    """step implementation Add the temporary placement credentials start date"""
...
def hr_portal_add_temporary_credentials_end_date(context):
    """step implementation Add the temporary placement credentials end date"""
...
def hr_portal_click_on_continue_button_for_temp_creation(context):
    """step implementation Click on the continue button for temp creation"""
...
def hr_portal_select_coventry_as_permanent_employer_option(context):
    """step implementation Select coventry as permanent employer option from dropdown"""
...
def hr_portal_add_details_in_department_field(context):
    """step implementation Add the details in department field"""
...
def hr_portal_add_details_in_department_contact_name_field(context):
    """step implementation Add the details in department contact name field"""
...
def hr_portal_add_details_in_department_contact_email_address_field(context):
    """step implementation Add the details in department contact email address field"""
...
def hr_portal_add_details_in_hr_contact_field(context):
    """step implementation Add the details in HR contact field"""
...
def hr_portal_add_details_in_approved_by_field(context):
    """step implementation Add the details in Approved by field"""
...
def hr_portal_select_yes_radio_button_for_licence_to_attend_field(context):
    """step implementation Select yes radio button option for Licence to attend field"""
...
def hr_portal_confirm_details_and_select_yes_radio_button_option(context):
    """step implementation Select yes radio button option for confirm details and provide credential heading"""
...
def hr_portal_validates_temp_placement_cred_provided_success_message(context):
    """step implementation Validate the Temporary placement credential provided success message"""
...
def hr_portal_validates_temp_placement_cred_passport_history(context):
    """step implementation Validate the passport history event details w.r.t temporary placement"""
