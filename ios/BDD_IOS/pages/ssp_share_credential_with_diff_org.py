...
class SsPortalShareCredWithDiffOrg(BasePage):
    """contains the page actions & objects related to the ss portal -Share credential with different organisation"""

    Review_credential_link_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Review credentials\"]"
    Accept_all_checkbox_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Accept all (28)\"]"
    Continue_button_xpath = AppiumBy.XPATH, "//XCUIElementTypeButton[@name=\"Continue\"]"
    Review_shared_credentials_heading_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Review shared credentials\"]"
    Yes_confirm_button_id = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Yes, confirm\"]"
    Status_confirmed_heading_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Status confirmed\"]"
    Status_confirmed_txt = "Status confirmed"
    hr_conflict_resolution_value_xpath = AppiumBy.XPATH, "(//XCUIElementTypeStaticText[@name=\"Conflict resolution\"])[1]"
    hr_portal_provided_by_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Provided by: University Hospitals Cov and Warwickshire\"]"
    hr_portal_reject_shared_creds_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Reject shared credential\"]"
    hr_portal_reject_shared_creds_text = "Reject shared credential"

    hr_portal_creds_value = '//XCUIElementTypeStaticText[@name="{dynamic_value}"]'
    ...
    def hr_portal_yes_confirm_radio_button(self):
        """Function to verify Review shared credential heading and select yes confirm button"""
    ...
    def hr_portal_status_confirmed_message(self):
        ...
        if self.verify_element_displayed(self.Status_confirmed_heading_xpath):
    ...
    def hr_portal_information_governance_data_security_creds_check(self):
        """Function to verify if Information governance and data security are shared and visible"""
        dynamic_value = "Information governance and data security"
        self.hr_portal_creds_check(dynamic_value)

    def hr_portal_moving_and_handling_level1_creds_check(self):
        """Function to verify if Moving and handling (Level 1) are shared and visible"""
        dynamic_value = "Moving and handling (Level 1)"
        self.hr_portal_creds_check(dynamic_value)

    def hr_portal_moving_and_handling_level2_creds_check(self):
        """Function to verify if Moving and handling (Level 2) are shared and visible"""
    ...
    def hr_portal_preventing_radicalisation_basic_prevent_awareness_creds_check(self):
        """Function to verify if Preventing radicalisation basic prevent awareness are shared and visible"""
    ...
    def hr_portal_preventing_radicalisation_prevent_awareness_creds_check(self):
        """Function to verify if Preventing radicalisation prevent awareness are shared and visible"""
        dynamic_value = "Preventing radicalisation prevent awareness"
        self.hr_portal_creds_check(dynamic_value)

    def hr_portal_resuscitation_creds_check(self):
        """Function to verify if resuscitation are shared and visible"""
        dynamic_value = "Resuscitation"
        self.hr_portal_creds_check(dynamic_value)

    def hr_portal_resuscitation_adult_basic_life_support_creds_check(self):
        """Function to verify if resuscitation adult basic life support are shared and visible"""
    ...
    def hr_portal_resuscitation_adult_immediate_life_support_creds_check(self):
        """Function to verify if resuscitation adult immediate life support are shared and visible"""
    ...
    def hr_portal_resuscitation_newborn_basic_life_support_creds_check(self):
        """Function to verify if resuscitation newborn basic life support are shared and visible"""
    ...
    def hr_portal_resuscitation_newborn_immediate_life_support_creds_check(self):
        """Function to verify if resuscitation newborn immediate life support are shared and visible"""
    ...
    def hr_portal_resuscitation_paediatric_basic_life_support_creds_check(self):
        """Function to verify if resuscitation paediatric basic life support are shared and visible"""
    ...
    def hr_portal_occupation_health_creds_reject_shared_credentials_check(self):
        """Function to verify if shared credentials with different organisation can have reject shared credentials"""
        if self.verify_element_displayed(self.hr_portal_provided_by_xpath):
