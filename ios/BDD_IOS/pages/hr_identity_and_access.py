...
class HRIdentityAndAccessPage(BasePage):
    ...
    identity_and_access_page_link_xpath = AppiumBy.XPATH, "(//XCUIElementTypeStaticText[@name=\"Identity and access\"])[1]"
    invite_staff_to_DSP_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Invite staff to Digital Staff Passport\"]"
    select_single_passport_radio_btn_id = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"A single passport using a form\"]"
    ...
    employment_type_xpath = AppiumBy.XPATH, "//XCUIElementTypeOther[@name=\"Employment type\" and @value=\"Select an option\"]"
    emp_type_select_xpath_permanent_fixed_term = AppiumBy.XPATH, "//XCUIElementTypeButton[@name=\"Permanent or fixed term\"]"
    employment_status_xpath = AppiumBy.XPATH, "//XCUIElementTypeOther[@name=\"Employment status\" and @value=\"Select an option\"]"
    employment_status_xpath_current_employer = AppiumBy.XPATH, "//XCUIElementTypeButton[@name=\"Current employee or leaver\"]"
    personal_details_continue_btn_xpath = AppiumBy.XPATH, "//XCUIElementTypeButton[@name=\"Continue\"]"
    create_passport_yes_radio_btn_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Yes, create this passport\"]"
    ...
    search_result_xpath = AppiumBy.XPATH, "(//XCUIElementTypeStaticText[@name=\"Full name\"])[2]/parent::XCUIElementTypeOther/XCUIElementTypeLink"
    review_identity_details_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Review identity details\"]"
    employment_dropdown_xpath = AppiumBy.XPATH, "//XCUIElementTypeOther[@name=\"Employment type\" and @value=\"Select an option\"]"
    ...
    country_dropdown_xpath = AppiumBy.XPATH, "//XCUIElementTypeOther[@name=\"Country\" and @value=\"Select their country\"]"
    country_select_united_kingdom_xpath = AppiumBy.XPATH, "//XCUIElementTypeButton[@name=\"United Kingdom\"]"
    yes_i_confirm_radio_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Yes, I confirm their identity and I want to provide an NHS identity credential.\"]"
    ...
    no_delete_passport_radio_btn_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"No, go back and keep this record\"]"
    yes_delete_passport_radio_btn_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Yes, delete staff passport from records\"]"
    delete_passport_continue_xpath = AppiumBy.XPATH, "//XCUIElementTypeButton[@name=\"Continue\"]"
    user_profile_heading_xpath = AppiumBy.XPATH, "//XCUIElementTypeOther[@name=\"Digital Staff Passport | Profile\"]/XCUIElementTypeOther[4]/XCUIElementTypeOther[2]/XCUIElementTypeStaticText"
    identity_and_access_text = "Identity and access"
    Delete_passport_msg_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"You will no longer see the record on the Identity and access table.\"]"
