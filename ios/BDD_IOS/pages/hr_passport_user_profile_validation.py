...
class HrPortalPassportUserProfileValidation(BasePage):
    ...
    passport_telephone_value_xpath = AppiumBy.XPATH, ("//XCUIElementTypeOther[@name=\"main\"]/XCUIElementTypeOther"
                                                       "/XCUIElementTypeOther[1]/XCUIElementTypeOther[2]/XCUIElementTypeLink")
    passport_email_id_value_xpath = AppiumBy.XPATH, ("//XCUIElementTypeOther[@name=\"main\"]/XCUIElementTypeOther"
                                                       "/XCUIElementTypeOther[1]/XCUIElementTypeOther[4]/XCUIElementTypeStaticText")
    passport_staff_group_value_xpath = AppiumBy.XPATH, ("//XCUIElementTypeOther[@name=\"main\"]/XCUIElementTypeOther"
                                                       "/XCUIElementTypeOther[1]/XCUIElementTypeOther[10]/XCUIElementTypeStaticText")
    passport_employment_type_value_xpath = AppiumBy.XPATH, ("//XCUIElementTypeOther[@name=\"main\"]/XCUIElementTypeOther"
                                                       "/XCUIElementTypeOther[1]/XCUIElementTypeOther[14]/XCUIElementTypeStaticText")
    passport_employment_status_value_xpath = AppiumBy.XPATH, ("//XCUIElementTypeOther[@name=\"main\"]/XCUIElementTypeOther"
                                                       "/XCUIElementTypeOther[1]/XCUIElementTypeOther[16]/XCUIElementTypeStaticText")
    ...
    complete_success_message_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Credentials required request completed\"]"
