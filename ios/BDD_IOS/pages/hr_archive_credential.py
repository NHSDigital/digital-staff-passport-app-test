...
class HRArchiveCredentialPage(BasePage):
    ...
    Credential_archived_restore_link_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Restore this credential\"]"
    Credential_restore_page_heading_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Credential restored\"]"
    Archive_this_credential_link_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Archive this credential\"]"
    Credential_archived_success_heading_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Credential archived\"]"
    ...
    Include_archived_credentials_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Include archived credentials\"]"
    Credential_archived_txt_xpath = AppiumBy.XPATH, '//XCUIElementTypeOther[@name="main"]/XCUIElementTypeOther[7]/XCUIElementTypeStaticText'
