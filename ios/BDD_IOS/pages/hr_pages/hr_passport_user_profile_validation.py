...
class HrPortalPassportUserProfileValidation(BasePage):
    ...
    passport_status_xpath = (
        AppiumBy.XPATH,
        '//XCUIElementTypeStaticText[@name="Passport status:"]',
    )
    passport_status_initial_value_xpath = (
        AppiumBy.XPATH,
        '//XCUIElementTypeStaticText[@name="Credentials Pending"]',
    )
    passport_status_initial_value_txt = "Credentials Pending"
    passport_show_all_details_xpath = (
        AppiumBy.XPATH,
        '//XCUIElementTypeButton[@value="Show all details"]',
    )
    passport_show_all_details_txt = "Show all details"
    passport_first_name_value_xpath = (
        AppiumBy.XPATH,
        '//XCUIElementTypeOther[@name="main"]/XCUIElementTypeOther'
        "/XCUIElementTypeOther[2]/XCUIElementTypeStaticText",
    )
    passport_last_name_value_xpath = AppiumBy.XPATH, (
        '//XCUIElementTypeOther[@name="main"]/XCUIElementTypeOther'
        "/XCUIElementTypeOther[4]/XCUIElementTypeStaticText"
    )
    passport_dob_xpath = AppiumBy.XPATH, (
        '//XCUIElementTypeOther[@name="main"]/XCUIElementTypeOther'
        "/XCUIElementTypeOther[8]/XCUIElementTypeStaticText"
    )
    passport_telephone_value_xpath = AppiumBy.XPATH, (
        '//XCUIElementTypeOther[@name="main"]/XCUIElementTypeOther'
        "/XCUIElementTypeOther[1]/XCUIElementTypeOther["
        "2]/XCUIElementTypeLink"
    )
    passport_email_id_value_xpath = AppiumBy.XPATH, (
        '//XCUIElementTypeOther[@name="main"]/XCUIElementTypeOther'
        "/XCUIElementTypeOther[1]/XCUIElementTypeOther["
        "4]/XCUIElementTypeStaticText"
    )
    passport_staff_group_value_xpath = AppiumBy.XPATH, (
        '//XCUIElementTypeOther[@name="main"]/XCUIElementTypeOther'
        "/XCUIElementTypeOther[1]/XCUIElementTypeOther["
        "10]/XCUIElementTypeStaticText"
    )
    passport_employment_type_value_xpath = AppiumBy.XPATH, (
        "//XCUIElementTypeOther["
        '@name="main"]/XCUIElementTypeOther'
        "/XCUIElementTypeOther[1]/XCUIElementTypeOther["
        "14]/XCUIElementTypeStaticText"
    )
    passport_employment_status_value_xpath = AppiumBy.XPATH, (
        "//XCUIElementTypeOther["
        '@name="main"]/XCUIElementTypeOther'
        "/XCUIElementTypeOther[1]/XCUIElementTypeOther["
        "16]/XCUIElementTypeStaticText"
    )
    complete_creds_required_xpath = (
        AppiumBy.XPATH,
        '//XCUIElementTypeButton[@name="Complete credentials required"]',
    )
    complete_creds_confirm_xpath = (
        AppiumBy.XPATH,
        '//XCUIElementTypeButton[@name="Complete credentials required"]',
    )
    complete_success_message_xpath = AppiumBy.XPATH, (
        '//XCUIElementTypeStaticText[@name="Credentials required request completed"]'
    )
    complete_success_message_txt = "Credentials required request completed"
    passport_status_complete_value_xpath = (
        AppiumBy.XPATH,
    ...
    def hr_portal_passport_page_initial_status_validation(self):
        ...
        element = self.read_value_from_element(
                self.passport_status_initial_value_xpath
            )
    ...
    def hr_portal_passport_page_firstname(self, value):
        ...
        self.verify_element_displayed(self.passport_first_name_value_xpath)
    ...
    def hr_portal_passport_page_lastname(self, value):
        ...
        self.verify_element_displayed(self.passport_last_name_value_xpath)
    ...
    def hr_portal_passport_page_dob(self, value):
        ...
        self.verify_element_displayed(self.passport_dob_xpath)
    ...
    def hr_portal_passport_page_telephone(self, value):
        ...
        self.verify_element_displayed(self.passport_telephone_value_xpath)
    ...
    def hr_portal_passport_page_email_address(self, value):
        ...
        self.verify_element_displayed(self.passport_email_id_value_xpath)
    ...
    def hr_portal_passport_page_staff_group(self, value):
        ...
        self.verify_element_displayed(self.passport_staff_group_value_xpath)
        element = self.read_value_from_element(
                self.passport_staff_group_value_xpath
            )
        assert element in value

    def hr_portal_passport_page_emp_type(self, value):
        """Function to verify the user employment type"""
        self.verify_element_displayed(self.passport_employment_type_value_xpath)
        element = self.read_value_from_element(
            self.passport_employment_type_value_xpath
        )
        assert element in value

    def hr_portal_passport_page_emp_stat(self, value):
        """Function to verify the user employment stat"""
        self.verify_element_displayed(self.passport_employment_status_value_xpath)
        element = self.read_value_from_element(
    ...
    def hr_portal_passport_page_complete_status_validation(self):
        ...
        self.verify_element_displayed(self.passport_status_xpath)
        element = self.read_value_from_element(
            self.passport_status_complete_value_xpath
        )
