...
class HRPortalCreateNewIdentityCredentialPage(BasePage):
    ...
    Create_new_identity_credential_link_xpath = AppiumBy.XPATH, ("//XCUIElementTypeStaticText[@name=\"Create a new "
                                                                 "identity credential\"]")
    Create_new_identity_cred_for_user_heading_xpath = AppiumBy.XPATH, ("//XCUIElementTypeOther["
    ...
    Confirm_users_details_heading_xpath = AppiumBy.XPATH, ("//XCUIElementTypeStaticText[contains(@name, \"Confirm\") "
                                                           "and contains(@name, \"details\")]")
    Yes_provide_credential_radio_button_xpath = AppiumBy.XPATH, ("//XCUIElementTypeStaticText[@name=\"Yes, provide "
                                                                 "credential\"]")
    No_go_back_radio_button_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"No, go back\"]"
    New_Identity_credential_provided_success_xpath = AppiumBy.XPATH, ("//XCUIElementTypeStaticText[@name=\"New "
