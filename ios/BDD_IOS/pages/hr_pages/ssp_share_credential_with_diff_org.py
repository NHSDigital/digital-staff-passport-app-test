...
class SsPortalShareCredWithDiffOrg(BasePage):
    ...
    Review_shared_credentials_heading_xpath = AppiumBy.XPATH, ("//XCUIElementTypeStaticText[@name=\"Review shared "
                                                               "credentials\"]")
    ...
    hr_conflict_resolution_value_xpath = AppiumBy.XPATH, ("(//XCUIElementTypeStaticText[@name=\"Conflict "
                                                          "resolution\"])[1]")
    hr_portal_provided_by_xpath = AppiumBy.XPATH, ("//XCUIElementTypeStaticText[@name=\"Provided by: University "
                                                   "Hospitals Cov and Warwickshire\"]")
    hr_portal_reject_shared_creds_xpath = AppiumBy.XPATH, ("//XCUIElementTypeStaticText[@name=\"Reject shared "
                                                           "credential\"]")
