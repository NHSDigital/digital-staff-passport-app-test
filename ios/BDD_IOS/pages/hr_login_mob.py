...
class HRPortalLoginMob(BasePage):
    ...
    password_id_xpath = AppiumBy.XPATH, "//XCUIElementTypeSecureTextField[@name=\"Password\"]"
    login_button_xpath = AppiumBy.XPATH, "//XCUIElementTypeButton[@name=\"Login\"]"
    digital_staff_passport_portal_text_xpath = AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name=\"Digital Staff Passport Portal\"]"
    ...
    def hr_portal_homepage(self):
        ...
        if self.verify_element_displayed(self.digital_staff_passport_portal_text_xpath):
            message = self.read_value_from_element(self.digital_staff_passport_portal_text_xpath)
