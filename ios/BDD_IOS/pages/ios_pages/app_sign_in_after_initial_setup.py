...
class SignInAfterInitialSetup(BasePage):
    ...
    continue_button_xpath = AppiumBy.ACCESSIBILITY_ID, "continue-button"
    forgotten_pin_heading_xpath = AppiumBy.ACCESSIBILITY_ID, "I've forgotten my PIN"
    ...
    incorrect_pin_4attempt_remaining_xpath = AppiumBy.ACCESSIBILITY_ID, "Incorrect PIN. You have 4 tries remaining."
    incorrect_pin_4attempt_remaining_text = "Incorrect PIN. You have 4 tries remaining."
    incorrect_pin_3attempt_remaining_xpath = AppiumBy.ACCESSIBILITY_ID, "Incorrect PIN. You have 3 tries remaining."
    incorrect_pin_3attempt_remaining_text = "Incorrect PIN. You have 3 tries remaining."
    incorrect_pin_2attempt_remaining_xpath = AppiumBy.ACCESSIBILITY_ID, "Incorrect PIN. You have 2 tries remaining."
    incorrect_pin_2attempt_remaining_text = "Incorrect PIN. You have 2 tries remaining."
    incorrect_pin_1attempt_remaining_xpath = AppiumBy.ACCESSIBILITY_ID, "Incorrect PIN. You have 1 tries remaining."
    ...
    def incorrect_pin_4attempts_remaining_error(self):
        ...
        message = self.read_value_from_element(self.incorrect_pin_4attempt_remaining_xpath)
        assert self.incorrect_pin_4attempt_remaining_text in message
        self.take_screenshot("PASS")
    ...
    def incorrect_pin_3attempts_remaining_error(self):
        ...
        message = self.read_value_from_element(self.incorrect_pin_3attempt_remaining_xpath)
        assert self.incorrect_pin_3attempt_remaining_text in message
        self.take_screenshot("PASS")
