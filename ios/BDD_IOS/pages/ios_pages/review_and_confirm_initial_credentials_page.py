...
class ReviewAndConfirmInitialCredentialsPage(BasePage):
    ...
    def verify_user_account_icon(self):
        ...
        return self.verify_element_displayed(self.account_icon)

    def verify_home_button(self):
        """method to verify the home button"""
        return self.verify_element_displayed(self.home_icon)
    ...
    def verify_right_to_work_credentials(self):
        ...
        return self.verify_element_displayed(self.right_to_work_credentials)

    def verify_dbs_supporting_documents(self):
        """method to verify the dbs supporting documents"""
        return self.verify_element_displayed(self.dbs_supporting_information)
    ...
    def verify_identity_credential_details(self):
        ...
        return self.verify_element_displayed(self.photo_of_your_face) and self.verify_element_displayed(self.name_title) and self.verify_element_displayed(self.name_value) and self.verify_element_displayed(self.dob_title) and self.verify_element_displayed(self.dob_value) and self.verify_element_displayed(self.legal_gender_title)


    def verify_something_not_right_link(self):
        """method to verify the something not right link"""
        return self.verify_element_displayed(self.something_is_not_right_link)

    def click_confirm_credential_button(self):
        """method to click on confirm credential button"""
        self.click_element(self.confirm_credential_button)


    def verify_confirming_credential_spinner(self):
        """method to verify the confirming credential spinner"""
        return self.verify_element_displayed(self.confirming_credentials_spinner)


    def verify_credentials_confirmed_page(self):
        """method to verify the credentials confirmed page"""
        return self.verify_element_displayed(self.credential_confirmed_title)

    def verify_text_on_page(self):
        """method to verify the text on the page"""
        return self.verify_element_displayed(self.credentials_confirmed_message)


    def click_back_to_my_credentials_button(self):
        """method to click back to my credentials button"""
        self.click_element(self.back_to_my_credentials_button)

    def verify_credentials_page(self):
        """method to verify the credentials page"""
        return self.verify_element_displayed(self.credentials_page_heading)
    ...
    def verify_right_to_work_credential_details(self):
        ...
        return self.verify_element_displayed(self.rtw_name_title) and self.verify_element_displayed(self.rtw_name_value) and self.verify_element_displayed(self.rtw_dob_title) and self.verify_element_displayed(self.rtw_dob_value) and self.verify_element_displayed(self.rtw_biometric_page_title) and self.verify_element_displayed(self.rtw_passport_expiry_date_title)


    def verify_something_went_wrong_link(self):
        """method to verify the something went wrong link"""
        return self.verify_element_displayed(self.rtw_something_is_not_right_link)
    ...
    def click_dbs_supporting_documents(self):
        ...
        self.click_element(self.dbs_supporting_information)

    def verify_dbs_supporting_documents_details(self):
        """method to verify the dbs supporting documents details"""
        return self.verify_element_displayed(self.dbs_name_title) and self.verify_element_displayed(self.dbs_name_value) and self.verify_element_displayed(self.dbs_dob_title) and self.verify_element_displayed(self.dbs_dob_value) and self.verify_element_displayed(self.dbs_verified_current_address_title) and self.verify_element_displayed(self.dbs_verified_current_address_value) and self.verify_element_displayed(self.dbs_resident_form_title) and self.verify_element_displayed(self.dbs_resident_from_value) and self.verify_element_displayed(self.dbs_passport_number_title) and self.verify_element_displayed(self.dbs_passport_number_value) and self.verify_element_displayed(self.dbs_pass)
