...
class DspBiometricPinError(BasePage):
    ...
    def app_pin_does_not_match_validation(self, error1):
        ...
        if self.verify_element_displayed(self.pin_error_pin_does_not_change_xpath):
            ...
            return error1 in message

    def app_pin_empty_validation(self, error2):
    ...
    def app_pin_alpha_numeric_validation(self, error2):
    ...
    def app_pin_sequential_validation(self, error2):
    ...
    def app_pin_reverse_sequential_validation(self, error2):
    ...
    def app_pin_not_repeated_validation(self, error1):
        """Function to validate error message when pin is not repeated"""
        if self.verify_element_displayed(self.pin_error_empty_xpath):
            message = self.read_value_from_element(self.pin_error_empty_xpath)
            assert error1 in message


    def app_pin_not_repeated_viceversa_validation(self, error2):
    ...
    def app_pin_not_six_digit_validation(self, error2):
